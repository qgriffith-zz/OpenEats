...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroceryAisle.author'
        db.add_column('list_groceryaisle', 'author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroceryAisle.author'
        db.delete_column('list_groceryaisle', 'author_id')
