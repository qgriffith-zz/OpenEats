...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroceryShared'
        db.create_table('list_groceryshared', (
        ...
        db.send_create_signal('list', ['GroceryShared'])


    def backwards(self, orm):
        
        # Deleting model 'GroceryShared'
        db.delete_table('list_groceryshared')
