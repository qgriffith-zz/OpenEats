...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroceryRecipe'
        db.create_table('list_groceryrecipe', (
        ...
        db.send_create_signal('list', ['GroceryRecipe'])


    def backwards(self, orm):
        
        # Deleting model 'GroceryRecipe'
        db.delete_table('list_groceryrecipe')
