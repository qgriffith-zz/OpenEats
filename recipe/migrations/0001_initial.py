...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('recipe_recipe', (
            ...
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipe_groups.Course'])),
            ('cuisine', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipe_groups.Cuisine'])),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'StoredRecipe'
        db.delete_table('recipe_storedrecipe')

        # Deleting model 'NoteRecipe'
        db.delete_table('recipe_noterecipe')
