...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReportedRecipe'
        db.create_table('recipe_reportedrecipe', (
        ...
        db.send_create_signal('recipe', ['ReportedRecipe'])


    def backwards(self, orm):
        
        # Deleting model 'ReportedRecipe'
        db.delete_table('recipe_reportedrecipe')
    ...
    models = {
        ...
        'recipe.reportedrecipe': {
            'Meta': {'object_name': 'ReportedRecipe'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['recipe.Recipe']"}),
