...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_userprofiles', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('about', self.gf('django.db.models.fields.TextField')(default='Tell everyone something about yourself', blank=True)),
            ('gender', self.gf('django.db.models.fields.CharField')(default='None', max_length=5, null=True)),
        ...
        db.send_create_signal('accounts', ['UserProfiles'])


    def backwards(self, orm):
        
        # Deleting model 'UserProfiles'
        db.delete_table('accounts_userprofiles')


    models = {
        'accounts.userprofiles': {
            'Meta': {'object_name': 'UserProfiles'},
            'about': ('django.db.models.fields.TextField', [], {'default': "'Tell everyone something about yourself'", 'blank': 'True'}),
            'gender': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '5', 'null': 'True'}),
