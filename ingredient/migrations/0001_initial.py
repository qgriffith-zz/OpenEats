...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ingredient_ingredient', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('quantity', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('measurement', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('preparation', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipe.Recipe'])),
        ))
        db.send_create_signal('ingredient', ['Ingredient'])


    def backwards(self, orm):
        
        # Deleting model 'Ingredient'
        db.delete_table('ingredient_ingredient')
    ...
    models = {
        ...
        'ingredient.ingredient': {
            'Meta': {'ordering': "['title']", 'object_name': 'Ingredient'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'measurement': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'preparation': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'recipe.recipe': {
            'Meta': {'ordering': "['pub_date', 'title']", 'object_name': 'Recipe'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'cook_time': ('django.db.models.fields.IntegerField', [], {}),
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['recipe_groups.Course']"}),
            'cuisine': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['recipe_groups.Cuisine']"}),
            ...
            'related': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'RecipeRelated'", 'unique': 'True', 'null': 'True', 'to': "orm['recipe.Recipe']"}),
        ...
        'recipe_groups.cuisine': {
            'Meta': {'ordering': "['title']", 'object_name': 'Cuisine'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '50', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'})
