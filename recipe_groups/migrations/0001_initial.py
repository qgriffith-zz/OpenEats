...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Course'
        db.create_table('recipe_groups_course', (
        ...
        db.send_create_signal('recipe_groups', ['Course'])

        # Adding model 'Cuisine'
        db.create_table('recipe_groups_cuisine', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(db_index=True, unique=True, max_length=50, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('recipe_groups', ['Cuisine'])


    def backwards(self, orm):
        
        # Deleting model 'Course'
        db.delete_table('recipe_groups_course')

        # Deleting model 'Cuisine'
        db.delete_table('recipe_groups_cuisine')
